...
import { dohURL, getParams } from "../helpers/init";
...
async function processVlessHeader(vlessBuffer: ArrayBuffer, userID: string) {
...
async function handleTCPOutBound(
  ...
  const { pathName, proxyIP } = getParams(request);
